      ...
      <section className="py-20 bg-gradient-to-r from-sky-500 to-sky-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-on-scroll">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Interested in Joining a Subunit?</h2>
            <p className="text-xl mb-8 opacity-90 leading-relaxed">
              We always welcome new talents! Choose your technical interest, develop your skills, and collaborate with passionate engineers who share your vision.
            </p>
            <Link 
